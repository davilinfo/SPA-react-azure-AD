    ...
    return (
        <>
            <div className="data-area-div">
                ...
                <ul>
                    <li><strong>resource:</strong> <strong>User</strong> object</li>
                    <li><strong>endpoint:</strong> <strong>https://graph.microsoft.com/v1.0/me</strong></li>
                    <li><strong>scope:</strong> <strong>user.read</strong></li>
                </ul>
